...
function checkForWin() {
    if (base3.length === 4) {
        document.querySelector('#communicator').innerHTML = 'You have won in way less time than it took me to make this game... congrats I guess'
        blockClickedOff()
        poleClickedOff()
        clearTimeout(t)
    }
...
function blockClicked(evt) {
    ...
    // store the parent id
    let addOnTopId = addOnTop.getAttribute("id")
}
